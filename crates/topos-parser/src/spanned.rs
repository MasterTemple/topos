...
// }
//
// pub trait RelativeFullSpan {
//     fn full_span(&self, start: usize) -> SimpleSpan;
//     fn full_span_start(&self, start: usize) -> usize {
//         self.full_span(start).start
//     }
//     fn full_span_end(&self, start: usize) -> usize {
//         self.full_span(start).end
//     }
// }
//
// #[derive(Clone, Debug)]
...
// }
//
// impl RelativeFullSpan for VerboseDelimeter {
//     fn full_span(&self, start: usize) -> SimpleSpan {
...
// }
//
// impl RelativeFullSpan for DelimitedNumber {
//     fn full_span(&self, start: usize) -> SimpleSpan {
//         // let start = self.delimeter.full_span_start();
//         let start = self.padded_number.full_span_start(start) - 1;
//         let end = self.padded_number.full_span_end(start);
//         SimpleSpan::from(start..end)
//     }
// }
//
...
// // }
//
// impl<T: FullSpan> RelativeFullSpan for FrontPadded<T> {
//     fn full_span(&self, start: usize) -> SimpleSpan {
//         if let Some(ref space) = self.space {
//             // let start = space.full_span_start();
//             let end = self.value.full_span_end();
